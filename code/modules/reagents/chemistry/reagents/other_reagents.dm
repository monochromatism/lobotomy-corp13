...
/datum/reagent/abnormality // The base abnormality chemical, with several "easy" modular traits that people can enable and disable with variables.
	name = "Raw Enkephalin"
	description = "You don't think you should be seeing this."
	reagent_state = LIQUID
	color = "#6baf65"
	...
	var/list/armorMods = list(0, 0, 0, 0) // Red, white, black, pale, in order. 10 = I, 50 = V, 100 = X. Applies additively. (Or subtractively, if negative.)
