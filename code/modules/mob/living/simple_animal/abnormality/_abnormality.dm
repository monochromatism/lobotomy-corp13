...
/mob/living/simple_animal/hostile/abnormality/proc/SpeedOverride(mob/living/carbon/human/user, work_speed, mod_work_speed, work_type)
	return work_speed

// Overrides the normal work chance. See SpeedOverride's comments; this behaves identically, but for work chance.
/mob/living/simple_animal/hostile/abnormality/proc/ChanceOverride(mob/living/carbon/human/user, work_chance, mod_work_chance, work_type)
	return work_chance
